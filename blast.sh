...
setup_environment() {
    ...
    [[ ! -f "conf/conf.local.php" && -f "conf/conf.dist.php" ]] && cp -p conf/conf.dist.php conf/conf.local.php && display_warning "Check/modify the newly created conf/conf.local.php"  && exit 0
